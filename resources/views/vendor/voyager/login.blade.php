            ...
            <div class="login-container">
                ...
                <form action="{{ route('voyager.login') }}" method="POST">
                    ...
                    <div class="form-group form-group-default" id="emailGroup">
                        <label>手机号码</label>
                        <div class="controls">
                            <input type="text" name="mobile" id="mobile" value="{{ old('mobile') }}" placeholder="{{ __('voyager::generic.mobile') }}" class="form-control" required>
                         </div>
                    </div>
                    ...
                    <div class="form-group" id="rememberMeGroup">
                        <div class="controls">
                        <input type="checkbox" name="remember" value="1"><span class="remember-me-text">记住我</span>
                        </div>
                    </div>
